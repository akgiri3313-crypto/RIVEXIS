  ...
  return (
    <div>
      <div className="mb-10 mt-4 md:mt-6">
        <div className="px-2">
          <div className="relative p-8 w-full h-full border border-slate-700/50 dark:border-slate-800 [mask-image:radial-gradient(200rem_24rem_at_center,white,transparent)]">
            <h1 className="tracking-tighter flex select-none px-3 py-2 flex-col text-center text-6xl font-extrabold leading-none sm:text-7xl md:flex-col lg:flex-row">
              ...
              <Plus className="absolute -right-4 -top-4 h-8 w-8 text-green-500" />
              <Plus className="absolute -bottom-4 -right-4 h-8 w-8 text-orange-500" />
